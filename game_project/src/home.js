                ...
                <div className="detail absolute w-full h-full  top-0  ">
                    ...
                    <div className="deatil2 relative w-full h-full  bg-transparent">
                       ...
                       <div className="shop absolute bottom-3 left-5 bg-transparent ">
                        ...
                        <button className="button rounded-[4px] overfolw-hidden bg-transparent w-fit" onClick={()=>{navigate(`/buy/${data[idx]._id}`)}}><button className="w-[100px] h-[35px] border-2 border-black sm:w-[160px] sm:h-[50px] rounded-[6px] bg-white mr-3 text-slate-950">BUY NOW</button></button>
                       </div>
