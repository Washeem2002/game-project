...
const Toast=()=>{
    ...
    return(
        <>{(mass.length!=0)&&(<div className={`w-[270px] h-[40px]  absolute right-[50%] translate-x-[50%] z-100 top-[50px] ${(mass.includes("removed"))||(mass.includes("check"))?"bg-red-500":"bg-green-500"} rounded`}>
